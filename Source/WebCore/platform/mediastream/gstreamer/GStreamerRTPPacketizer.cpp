...
int GStreamerRTPPacketizer::findLastExtensionId(const GstCaps* caps)
{
    ...
    gst_structure_foreach(rtpStructure, reinterpret_cast<GstStructureForeachFunc>(+[](GQuark quark, const GValue*, gpointer userData) -> gboolean {
        ...
        auto holder = reinterpret_cast<ExtensionIdHolder*>(userData);
