...
public:
    ...
    CodecLookupResult areCapsSupported(Configuration, const GRefPtr<GstCaps>&, bool shouldCheckForHardwareUse, std::optional<Vector<String>> disallowedList = std::nullopt) const;
