...
public:
    ...
    virtual void send(unsigned, RTCIceComponent, std::span<const uint8_t>) = 0;
...
void webkitGstWebRTCIceAgentSend(WebKitGstIceAgent*, unsigned, WebCore::RTCIceComponent, std::span<const uint8_t>);
