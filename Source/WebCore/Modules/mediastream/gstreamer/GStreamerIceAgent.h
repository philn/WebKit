...
public:
    ...
    virtual bool send(unsigned, RTCIceComponent, std::span<const uint8_t>) = 0;
...
GstFlowReturn webkitGstWebRTCIceAgentSend(WebKitGstIceAgent*, unsigned, WebCore::RTCIceComponent, std::span<const uint8_t>);
